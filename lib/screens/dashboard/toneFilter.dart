...
class ToneFilterScreen extends StatefulWidget {
  @override
  _ToneFilterScreenState createState() => _ToneFilterScreenState();
}

class _ToneFilterScreenState extends State<ToneFilterScreen> {
  String name;
  String email;
